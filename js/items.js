(function (window) {
  ...
  var chests1 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 2 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 1 : 0);
  var chests2 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 2 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 1 : 0);
  var chests3 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 5 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 6 : 0);
  var chests4 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 6 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 1 : 0);
  var chests5 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 2 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 3 : 0);
  var chests6 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 4 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 1 : 0);
  var chests7 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 3 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 2 : 0);
  var chests8 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 2 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 3 : 0);
  var chests9 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 5 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 4 : 0);
  var chests10 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 20 + chestmod + (flags.wildkeys || flags.gametype === "R" ? 4 : 0);
  var chests11 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
      : 6 +
        (flags.wildmaps ? 1 : 0) +
        (flags.wildkeys || flags.gametype === "R" ? 1 : 0);
  var chests12 =
    flags.doorshuffle === "C"
      ? 3 + chestmodcrossed
