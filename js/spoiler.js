(function (window) {
  ...
  window.isTrashItem = function (itemName) {
    return (
      trashItems.includes(itemName) ||
      (mapsAreTrash && itemName.startsWith("Map")) ||
      (compassesAreTrash && itemName.startsWith("Compass"))
    );
  };

  window.setDungeonContents = function (
    dungeonIndex,
    region,
    prefix,
    locationNames,
    ...
    for (var i = 0; i < locationNames.length; i++) {
      var locationName = locationNames[i],
        fullName = prefix + locationName;
      if (fullName in region) {
        var item = region[fullName],
          niceName = getNiceName(item),
        ...
        if (isTrashItem(item)) {
          trashString =
            trashString === ""
              ? itemAtLocation
              : trashString + ", " + itemAtLocation;
        } else {
          niceString =
            niceString === ""
              ? itemAtLocation
              : niceString + ", " + itemAtLocation;
        }
      } else
        alert(
  ...
  window.setContent = function (chestIndex, region, locationName) {
    ...
    } else alert("Could not find location " + locationName);
  };
  ...
  window.setContents = function (chestIndex, region, locationNames) {
    ...
    for (var i = 0; i < locationNames.length; i++) {
      ...
      if (locationName in region) {
        var item = region[locationName];
        content +=
          content === "" ? getNiceName(item) : ", " + getNiceName(item);
        if (trash && !isTrashItem(item)) trash = false;
      } else
        alert(
          "Could not find location " +
            locationName +
  ...
  window.loadSpoiler = function (s) {
    spoiler = s;
    var light = spoiler["Light World"],
      dark = spoiler["Dark World"],
      mountain = spoiler["Death Mountain"],
      bosses = spoiler["Bosses"],
      special = spoiler["Special"];
    var ep = spoiler["Eastern Palace"],
      dp = spoiler["Desert Palace"],
      toh = spoiler["Tower Of Hera"],
      castle = spoiler["Hyrule Castle"],
      aga = spoiler["Castle Tower"];
    var pod = spoiler["Dark Palace"],
      sp = spoiler["Swamp Palace"],
      sw = spoiler["Skull Woods"],
      tt = spoiler["Thieves Town"],
      ip = spoiler["Ice Palace"],
      mm = spoiler["Misery Mire"],
      tr = spoiler["Turtle Rock"],
      gt = spoiler["Ganons Tower"];
    ...
    window.setDungeonContents(0, ep, "Eastern Palace - ", [
      "Cannonball Chest",
      "Map Chest",
      "Compass Chest",
      "Big Chest",
    ...
    window.setDungeonContents(1, dp, "Desert Palace - ", [
      "Map Chest",
      "Torch",
      "Compass Chest",
      "Big Key Chest",
    ...
    window.setDungeonContents(2, toh, "Tower of Hera - ", [
      "Basement Cage",
      "Map Chest",
      "Big Key Chest",
      "Compass Chest",
    ...
    window.setDungeonContents(3, pod, "Palace of Darkness - ", [
      "Shooter Room",
      "The Arena - Bridge",
      "Big Key Chest",
      "Stalfos Basement",
    ...
    window.setDungeonContents(4, sp, "Swamp Palace - ", [
      "Entrance",
      "Map Chest",
      "Compass Chest",
      "Big Chest",
    ...
    window.setDungeonContents(5, sw, "Skull Woods - ", [
      "Compass Chest",
      "Pot Prison",
      "Pinball Room",
      "Map Chest",
    ...
    window.setDungeonContents(6, tt, "Thieves' Town - ", [
      "Map Chest",
      "Ambush Chest",
      "Compass Chest",
      "Big Key Chest",
    ...
    window.setDungeonContents(7, ip, "Ice Palace - ", [
      "Compass Chest",
      "Spike Room",
      "Map Chest",
      "Big Key Chest",
    ...
    window.setDungeonContents(8, mm, "Misery Mire - ", [
      "Bridge Chest",
      "Spike Chest",
      "Compass Chest",
      "Big Key Chest",
    ...
    window.setDungeonContents(9, tr, "Turtle Rock - ", [
      "Compass Chest",
      "Roller Room - Left",
      "Roller Room - Right",
      "Chain Chomps",
    ...
    window.setDungeonContents(10, gt, "Ganon's Tower - ", [
      "Hope Room - Right",
      "Hope Room - Left",
      "Tile Room",
    ...
    if (flags.mapmode != "N") {
      ...
      window.setContents(17, mountain, [
