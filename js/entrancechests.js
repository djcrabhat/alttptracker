(function (window) {
  ...
  function medallionCheck(i) {
    if (
      (items.sword === 0 && flags.swordmode != "S") ||
      (!items.bombos && !items.ether && !items.quake)
    )
      return "unavailable";
    if (
      (medallions[i] === 1 && !items.bombos) ||
      (medallions[i] === 2 && !items.ether) ||
      (medallions[i] === 3 && !items.quake)
    )
      return "unavailable";
    if (items.bombos && items.ether && items.quake) return "available";
    if (medallions[i] === 0 && !(items.bombos && items.ether && items.quake))
      return "possible";
    return "available";
  }
  ...
  function canReachDarkWorld() {
    return (
      items.moonpearl &&
      (items.glove === 2 || (items.glove && items.hammer) || items.agahnim)
    );
  }

  function canReachLightWorld() {
    //Can walk around in Light World as Link
    return (
      items.moonpearl &&
      (items.glove === 2 || (items.glove && items.hammer) || items.agahnim)
    );
  ...
  function canReachLightWorldBunny() {
    //Can walk around in Light World as bunny or Link
    return (
      items.agahnim ||
      canReachLightWorld() ||
  ...
  function canReachPyramid() {
    return (
      canReachDarkWorld() &&
      (items.flippers || canReachPyramidWithoutFlippers())
    );
  }
  ...
  function canReachPyramidWithoutFlippers() {
    return (
      items.hammer ||
      activeFluteInvertedEntrance() ||
      (items.mirror && canReachLightWorldBunny())
    );
  }
  ...
  function activeFluteInvertedEntrance() {
    return (
      items.flute && (canReachInvertedLightWorld() || flags.activatedflute)
    );
  }
  ...
  function canReachWDMNorth() {
    if (
      hasFoundEntrance(68) ||
      (hasFoundEntrance(77) && items.hammer) ||
      (items.mirror &&
        (hasFoundEntrance(69) ||
          hasFoundEntrance(70) ||
          hasFoundEntrance(71) ||
          ...
          hasFoundEntrance(75) ||
          hasFoundEntrance(76) ||
          hasFoundEntrance(127) ||
          hasFoundEntrance(131) ||
          hasFoundEntrance(132) ||
          hasFoundEntrance(133) ||
          hasFoundEntrance(136))) ||
      (items.flute && items.mirror)
    )
      return true;
    if (
      items.mirror &&
    ...
    if (
      items.mirror &&
      items.hammer &&
      (hasFoundEntrance(128) || hasFoundEntrance(130))
    )
      return true;
    ...
    if (
      ...
      (items.hookshot &&
        (hasFoundEntrance(77) ||
          ...
          hasFoundEntrance(83) ||
          hasFoundEntrance(84) ||
          ((hasFoundEntrance(137) ||
            hasFoundEntrance(138) ||
            hasFoundEntrance(139)) &&
            items.mirror))) ||
      hasFoundEntrance(69) ||
      hasFoundEntrance(70) ||
      hasFoundEntrance(71) ||
  ...
  function canReachEDMNorth() {
    if (
      (canReachWDMNorth() && items.hammer) ||
      hasFoundEntrance(77) ||
      (hasFoundEntrance(68) && items.hammer) ||
      (items.mirror &&
        (hasFoundEntrance(127) ||
          hasFoundEntrance(131) ||
          hasFoundEntrance(132) ||
          hasFoundEntrance(133) ||
          hasFoundEntrance(136))) ||
      (items.flute && items.mirror && items.hammer)
    )
      return true;
    return false;
  }
  ...
  function canReachEDM() {
    if (
      canReachEDMNorth() ||
      (items.flute && items.hookshot) ||
      (items.hookshot && canReachWDM()) ||
      (items.hammer && canReachWDMNorth()) ||
      ((hasFoundEntrance(134) ||
        hasFoundEntrance(135) ||
        hasFoundEntrance(137) ||
        hasFoundEntrance(138) ||
        hasFoundEntrance(139)) &&
        items.mirror) ||
  ...
  function canReachHCNorth() {
    if (
      ...
      ((items.agahnim ||
        ...
        items.mirror) ||
      (canReachDarkWorldEast() && items.mirror)
    )
      return true;
    return false;
  }
  ...
  function canReachOutcast() {
    ...
    if (
      hasFoundEntrance(90) ||
      hasFoundEntrance(91) ||
      (flags.doorshuffle === "N" && hasFoundEntrance(96)) ||
      hasFoundEntrance(99) ||
      hasFoundEntrance(102) ||
      hasFoundEntrance(104) ||
      hasFoundEntrance(105) ||
      hasFoundEntrance(106) ||
      hasFoundEntrance(107) ||
      hasFoundEntrance(108) ||
      hasFoundEntrance(109) ||
      (hasFoundEntrance(110) && items.moonpearl && items.hammer) ||
      hasFoundEntrance(111) ||
      (hasFoundEntrance(112) && items.moonpearl && items.glove === 2) ||
      hasFoundEntrance(129)
    )
      return true;
    if (
      (hasFoundEntrance(86) ||
        ...
        hasFoundEntrance(88) ||
        hasFoundEntrance(89) ||
        hasFoundEntrance(113) ||
        hasFoundEntrance(119)) &&
      items.moonpearl &&
      (items.glove === 2 ||
        (items.flippers && items.hookshot) ||
        (items.glove > 0 && items.hammer && items.hookshot))
    )
      return true;
    if (
      canReachDarkWorldEast() &&
      items.moonpearl &&
      (items.flippers || items.hammer || items.glove > 0) &&
      items.hookshot
    )
      return true;
  ...
  function canReachDarkWorldEast() {
    ...
    if (
      ...
      hasFoundEntrance(94) ||
      hasFoundEntrance(95) ||
      hasFoundEntrance(114) ||
      hasFoundEntrance(115) ||
      hasFoundEntrance(116) ||
      hasFoundEntrance(117) ||
      ((hasFoundEntrance(86) ||
        hasFoundEntrance(87) ||
        hasFoundEntrance(88) ||
        hasFoundEntrance(89) ||
    ...
    if (
      (hasFoundEntrance(90) ||
        ...
        hasFoundEntrance(108) ||
        hasFoundEntrance(109) ||
        (hasFoundEntrance(110) && items.hammer) ||
        hasFoundEntrance(111) ||
        hasFoundEntrance(129)) &&
      items.moonpearl &&
  ...
  function canReachDarkWorldSouthEast() {
    if (
      hasFoundEntrance(120) ||
      hasFoundEntrance(121) ||
      hasFoundEntrance(122) ||
      ((canReachDarkWorld() ||
        canReachDarkWorldEast() ||
        canReachDarkWorldSouth()) &&
        items.flippers &&
        items.moonpearl)
    )
      return true;
  ...
  function canReachMiseryMire() {
    if (
      hasFoundEntrance(123) ||
      hasFoundEntrance(124) ||
      hasFoundEntrance(125) ||
      hasFoundEntrance(126) ||
      (items.flute && items.glove === 2)
    )
      return true;
  }
  ...
  function canReachDWDMNorth() {
    if (
      ...
      hasFoundEntrance(133) ||
      hasFoundEntrance(136) ||
      (canReachEDMNorth() && items.hammer && items.glove === 2)
    )
      return true;
    return false;
  }
  ...
  function canReachDWWDM() {
    if (canReachDWDMNorth() || hasFoundEntrance(128) || hasFoundEntrance(130))
      return true;
    return false;
  }
  ...
  function canReachDWEDM() {
    if (
      ...
      hasFoundEntrance(134) ||
      hasFoundEntrance(135) ||
      (canReachEDM() && items.glove === 2 && items.moonpearl)
    )
      return true;
    return false;
  }
  ...
  function canReachInvertedLightWorld() {
    // for inverted, can walk around in Light World as Link
    return (
      items.moonpearl &&
      (canReachInvertedLightWorldBunny() ||
        hasFoundEntrance(4) ||
        (hasFoundEntrance(5) && items.flippers) ||
        hasFoundEntrance(11) ||
        hasFoundEntrance(16) ||
        (hasFoundEntrance(17) && items.glove === 2) ||
        hasFoundEntrance(37) ||
        hasFoundEntrance(38) ||
        (hasFoundEntrance(56) && items.glove) ||
        (hasFoundEntrance(64) && items.flippers))
    );
  }

  function canReachInvertedLightWorldBunny() {
    // for inverted, can walk around in Light World as bunny or Link
    // LW entrances that are bunny accessible, plus aga and flute 6 portal
    if (
      items.agahnim /* || (items.glove === 2 && activeFlute()) */ ||
      hasFoundEntrance(0) ||
      hasFoundEntrance(1) ||
      hasFoundEntrance(2) ||
      hasFoundEntrance(3) ||
  ...
  function canReachInvertedNorthDW() {
    ...
    if (
      hasFoundEntrance(92) &&
      ((items.hammer && items.glove === 2) || items.hookshot)
    )
      return true;
    ...
    if (
      ...
      (canReachInvertedLightWorldBunny() ||
        hasFoundEntrance(16) ||
        hasFoundEntrance(17) ||
        (hasFoundEntrance(37) && items.hammer) ||
        hasFoundEntrance(38))
    )
      return true;
    return false;
  ...
  function canReachInvertedEastDW() {
    ...
    if (canReachInvertedSouthDW() && (items.flippers || items.hammer))
      return true;
    // flute 5
    if (activeFluteInvertedEntrance()) return true;
    // LW + mirror
    if (
      items.mirror &&
      (canReachInvertedLightWorldBunny() ||
        ((items.hammer || items.glove) && hasFoundEntrance(4)) ||
        hasFoundEntrance(11))
    )
      return true;
    return false;
  ...
  function canReachInvertedDarkDeathMountain() {
    ...
    if (
      hasFoundEntrance(127) ||
      hasFoundEntrance(128) ||
      hasFoundEntrance(130) ||
      hasFoundEntrance(131) ||
      hasFoundEntrance(132) ||
      hasFoundEntrance(133) ||
      hasFoundEntrance(136)
  ...
  function canReachInvertedEastDeathMountain() {
    ...
    if (
      items.moonpearl &&
      items.hookshot &&
      canReachInvertedWestDeathMountain()
    )
      return true;
    ...
    if (
      items.glove === 2 &&
      (canReachInvertedDarkDeathMountain() ||
        hasFoundEntrance(134) ||
        hasFoundEntrance(135) ||
        hasFoundEntrance(137))
    )
  ...
  window.loadChestFlagsEntrance = function () {
    window.dungeonChecks = [
      ...
      },
      {
        ...
        can_get_chest: function () {
          entranceChests(
            ["hc_m", "hc_w", "hc_e", "placeholder", "placeholder"],
            11,
          );
        },
      },
    ...
    if (flags.gametype === "I") {
      window.entrances = [
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return items.boots && canReachInvertedLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return items.flippers && canReachInvertedLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            return canReachInvertedLightWorld() && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return items.agahnim || items.agahnim2
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              crystalCheck() < flags.opentowercount &&
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return items.glove && canReachInvertedLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return items.agahnim && items.boots && canReachInvertedLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return items.hammer && canReachInvertedLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return items.book && canReachInvertedLightWorldBunny()
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            if (items.moonpearl && items.glove && hasFoundEntrance(56))
              return "available";
            return "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (items.moonpearl && items.glove && hasFoundEntrance(54))
              return "available";
            return "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              items.glove === 2 &&
              items.flippers &&
              (canReachInvertedSouthDW() || canReachInvertedEastDW())
            )
              return "available";
            return items.flippers && canReachInvertedLightWorld()
              ? "available"
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return canReachInvertedLightWorld() && items.glove
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            if (items.moonpearl && items.hammer && hasFoundEntrance(77))
              return "available";
            if (
              items.moonpearl &&
              items.hammer &&
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return canReachInvertedWestDeathMountain()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (items.moonpearl && items.hammer && hasFoundEntrance(68))
              return "available";
            if (
              items.moonpearl &&
              items.hammer &&
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return canReachInvertedEastDeathMountain()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            if (hasFoundEntrance(77) || hasFoundEntrance(80))
              return "available";
            if (items.moonpearl && items.hammer && hasFoundEntrance(68))
              return "available";
            if (
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            if (hasFoundEntrance(77) || hasFoundEntrance(83))
              return "available";
            if (items.moonpearl && items.hammer && hasFoundEntrance(68))
              return "available";
            if (
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              items.moonpearl &&
              items.glove === 2 &&
              canReachInvertedEastDeathMountain()
            )
              return "available";
            if (items.moonpearl && items.hammer && hasFoundEntrance(68))
              return "available";
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            if (hasFoundEntrance(77) || hasFoundEntrance(85))
              return "available";
            if (items.moonpearl && items.hammer && hasFoundEntrance(68))
              return "available";
            if (
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return canReachInvertedSouthDW() && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (items.mirror && canReachInvertedLightWorld())
              return "available";
            if (
              items.flippers &&
              (canReachInvertedNorthDW() ||
                canReachInvertedSouthDW() ||
                canReachInvertedEastDW())
            )
              return "available";
            if ((items.hammer || items.glove) && canReachInvertedEastDW())
              return "available";
            return "unavailable";
          },
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return items.agahnim2 || hasFoundEntrance(93)
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            var crystal_count = 0;
            for (var k = 0; k < 10; k++)
              if (prizes[k] === 4 && items["boss" + k]) crystal_count += 1;
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (items.firerod && (hasFoundEntrance(97) || hasFoundEntrance(98)))
              return "available";
            if (!items.firerod || !canReachInvertedNorthDW())
              return "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return items.glove && canReachInvertedNorthDW()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              ...
              return "available";
            return items.hammer && canReachInvertedNorthDW()
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            return canReachInvertedNorthDW() && items.bomb
              ? "available"
              : "unavailable";
          },
        },
          ...
          is_available: function () {
            ...
            if (items.bomb) {
              if (
                ...
                return "available";
              if (items.mirror && canReachInvertedLightWorldBunny())
                return "available";
              if (
                items.flippers &&
                (canReachInvertedEastDW() || canReachInvertedSouthDW())
              )
                return "available";
            }
            return "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return items.glove && canReachInvertedDarkDeathMountain()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            if (hasFoundEntrance(134) || hasFoundEntrance(135))
              return "available";
            if (
              items.mirror &&
              (hasFoundEntrance(78) ||
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            if (hasFoundEntrance(138) || hasFoundEntrance(139))
              return "available";
            if (!items.mirror) return "unavailable";
            if (
              hasFoundEntrance(77) ||
      ...
      window.dungeons = [
        ...
        },
        {
          ...
          is_beatable: function () {
            if (
              !(items.glove || activeFluteInvertedEntrance()) ||
              !items.moonpearl ||
              !items.hammer ||
              !(items.hookshot || items.glove === 2)
            )
              return "unavailable";
        ...
        },
        {
          ...
          is_beatable: function () {
            ...
            if (
              items.mirror &&
              ((items.hookshot && items.moonpearl) || items.glove === 2)
            ) {
          ...
          can_get_chest: function () {
            if (!(items.glove || activeFluteInvertedEntrance()))
              return "unavailable";
            //First, check for back door access through mirror, it has logic priority
            if (
              items.mirror &&
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            if (crystalCheck() < flags.ganonvulncount || !canReachLightWorld())
              return "unavailable";
            if (
              flags.goals === "F" &&
              (items.sword > 1 || (flags.swordmode === "S" && items.hammer)) &&
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            return items.chest11
              ? window.dungeons[11].can_get_chest()
              : "opened";
          },
          can_get_chest: function () {
      ...
      window.chests = [
        ...
        },
        {
          ...
          is_available: function () {
            return (items.mirror ||
              (items.glove === 2 && canReachInvertedNorthDW())) &&
              canReachInvertedLightWorldBunny()
              ? "available"
              : "unavailable";
          },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (hasFoundEntrance(68))
              return items.sword >= 2 ||
                (flags.swordmode === "S" && items.hammer)
                ? "available"
                : "information";
            if (items.moonpearl && items.hammer && hasFoundEntrance(77))
              return items.sword >= 2 ||
          ...
          is_available: function () {
            if (
              ...
              (hasFoundEntrance(68) ||
                (items.moonpearl &&
                  items.hammer &&
                  (items.glove === 2 || hasFoundEntrance(77))))
            )
              return items.lantern ? "available" : "darkavailable";
            if (canReachInvertedWestDeathMountain())
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            if (!canReachInvertedLightWorldBunny()) return "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              (items.hammer || (items.flippers && items.glove)) &&
              canReachInvertedNorthDW()
            )
              return "available";
            return "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            if (!canReachInvertedLightWorld()) return "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.shovel && canReachInvertedLightWorld()
              ? "available"
              : "unavailable";
          },
        },
      ...
      window.dungeons = [
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            if (!(activeFlute() || (items.mirror && canReachLightWorldBunny())))
              return "unavailable";
            if (!items.boots && !items.hookshot) return "unavailable";
            if (!items.bigkey8) return "unavailable";
            var state = medallionCheck(0);
      ...
      window.entrances = [
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return items.mirror && canReachDarkWorldSouth()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(16)) return "available";
            return items.mirror && items.moonpearl && canReachOutcast()
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            if (!items.boots) return "unavailable";
            if (
              (canReachOutcast() && items.mirror && items.moonpearl) ||
              items.glove === 2
            )
              return "available";
            return "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(26)) return "available";
            return items.glove > 0 || (hasFoundEntrance(105) && items.mirror)
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_connector: false,
          is_available: function () {
            return (hasFoundEntrance(112) && items.mirror) ||
              items.hammer ||
              (items.glove === 2 && items.mirror && items.moonpearl)
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(46)) return "available";
            return canReachDarkWorldSouth() && items.mirror
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              items.book ||
              (items.flute && items.glove === 2 && items.mirror) ||
              (items.mirror && canReachMiseryMire()) ||
              (hasFoundEntrance(123) && items.mirror)
            )
              return "available";
            return "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            return (items.flute && items.glove === 2 && items.mirror) ||
              (items.mirror && canReachMiseryMire()) ||
              (hasFoundEntrance(56) && items.glove > 0)
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(56)) return "available";
            return (hasFoundEntrance(54) && items.glove > 0) ||
              (items.mirror && canReachMiseryMire()) ||
              (items.flute && items.glove === 2 && items.mirror)
              ? "available"
              : "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(57)) return "available";
            return canReachMiseryMire() && items.mirror && items.glove > 0
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(68)) return "available";
            if ((canReachDWWDM() || canReachWDM()) && items.mirror)
              return "available";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return canReachEDMNorth() ||
              hasFoundEntrance(80) ||
              ((hasFoundEntrance(138) || hasFoundEntrance(139)) && items.mirror)
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return canReachEDMNorth() || (hasFoundEntrance(137) && items.mirror)
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            if (items.moonpearl && items.mirror && canReachDWEDM())
              return "available";
            return hasFoundEntrance(83) ||
              canReachEDMNorth() ||
              (canReachEDM() && items.glove === 2) ||
              (hasFoundEntrance(137) && items.mirror)
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            return items.mirror &&
              (hasFoundEntrance(138) || hasFoundEntrance(139))
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(87)) return "available";
            return canReachDarkWorldSouth() && items.boots && items.moonpearl
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            return canReachDarkWorldSouth() && items.moonpearl && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (canReachOutcast() && items.moonpearl && items.flippers)
              return "available";
            return canReachDarkWorldEast() &&
              items.moonpearl &&
              (items.flippers || items.glove > 0 || items.hammer)
              ? "available"
              : "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return canReachPyramid() || canReachDarkWorldEast()
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            if (
              crystal_count >= 2 &&
              (canReachPyramid() || canReachDarkWorldEast())
            ) {
              return hasFoundLocation("bomb") ? "available" : "possible";
            }
            return "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(96)) return "available";
            if (
              (hasFoundEntrance(97) || hasFoundEntrance(98)) &&
              items.moonpearl &&
              items.firerod
            )
              return "available";
            return canReachOutcast() && items.moonpearl && items.firerod
              ? flags.doorshuffle === "N"
                ? "available"
                : "possible"
              : "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              (hasFoundEntrance(96) || hasFoundEntrance(98)) &&
              items.moonpearl
            )
              return "available";
            return canReachOutcast() && items.moonpearl
              ? flags.doorshuffle === "N"
                ? "available"
                : "possible"
              : "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (
              (hasFoundEntrance(96) || hasFoundEntrance(97)) &&
              items.moonpearl
            )
              return "available";
            return canReachOutcast() && items.moonpearl
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(105)) return "available";
            return canReachOutcast() && items.glove > 0 && items.moonpearl
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(110)) return "available";
            return canReachOutcast() && items.moonpearl && items.hammer
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(111)) return "available";
            return canReachOutcast() && items.moonpearl && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return canReachOutcast() || canReachDarkWorldSouth()
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            ...
            return items.moonpearl && canReachDarkWorldEast()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(120)) return "available";
            return canReachDarkWorldSouthEast() && items.moonpearl && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(122)) return "available";
            return canReachDarkWorldSouthEast() &&
              items.moonpearl &&
              items.glove > 0
              ? "available"
              : "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return canReachWDM() || canReachWDMNorth() || canReachDWWDM()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (hasFoundEntrance(132)) return "available";
            return canReachDWDMNorth() && items.moonpearl && items.glove > 0
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return canReachDWEDM() || (canReachEDM() && items.glove === 2)
              ? "available"
              : "unavailable";
          },
        },
      ...
      window.dungeons = [
        {
          ...
          is_beatable: function () {
            return dungeonBoss(
              0,
              [hasFoundLocation("ep") ? "available" : "unavailable"],
              [false],
            );
          },
          can_get_chest: function () {
        ...
        },
        {
          ...
          is_beatable: function () {
            return dungeonBoss(
              1,
              [
                hasFoundLocation("dp_m") ? "available" : "unavailable",
                hasFoundLocation("dp_w") ? "available" : "unavailable",
                hasFoundLocation("dp_e") ? "available" : "unavailable",
                hasFoundLocation("dp_n") ? "available" : "unavailable",
              ],
        ...
        },
        {
          ...
          is_beatable: function () {
            return dungeonBoss(
              2,
              [hasFoundLocation("toh") ? "available" : "unavailable"],
              [false],
            );
          },
          can_get_chest: function () {
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            if (!canReachDarkWorld() || !items.mirror || !items.flippers)
              return "unavailable";
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            if (!canReachOutcast() || !canReachDarkWorld())
              return "unavailable";
            return window.SWBoss();
          },
          can_get_chest: function () {
        ...
        },
        {
          ...
          is_beatable: function () {
            ...
            if (
              !items.firerod &&
              (!items.bombos ||
                (items.bombos && items.sword == 0 && flags.swordmode != "S"))
            )
              return "unavailable";
            return window.IPBoss();
          },
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            if (crystalCheck() < flags.ganonvulncount || !canReachDarkWorld())
              return "unavailable";
            //Fast Ganon
            if (
              flags.goals === "F" &&
              (items.sword > 1 ||
                (flags.swordmode === "S" && (items.hammer || items.net))) &&
              (items.lantern || items.firerod)
            )
              return "available";
            return window.GTBoss();
      ...
      window.chests = [
        ...
        },
        {
          ...
          is_available: function () {
            if (
              (canReachWDMNorth() || (canReachDWWDM() && items.mirror)) &&
              items.book
            ) {
              return items.sword >= 2 ||
                (flags.swordmode === "S" && items.hammer)
        ...
        },
        {
          ...
          is_available: function () {
            if (
              (canReachDarkWorldEast() || hasFoundEntrance(92)) &&
              items.moonpearl &&
              items.glove
            )
              return "available";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return hasFoundEntrance(131) && items.mirror
              ? "available"
              : canReachEDMNorth()
                ? "information"
                : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return hasFoundEntrance(46) ||
              (canReachDarkWorldSouth() && items.mirror)
              ? "available"
              : "information";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            return items.flippers &&
              items.mirror &&
              items.moonpearl &&
              (canReachDarkWorldEast() || canReachDarkWorldSouth())
              ? "available"
              : "information";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            return items.moonpearl &&
              (canReachOutcast() ||
                canReachDarkWorldSouth() ||
                (items.agahnim && items.moonpearl && items.hammer))
              ? "available"
              : "unavailable";
          },
        },
