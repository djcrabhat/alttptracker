(function (window) {
  ...
  function agatowerweapon() {
    return (
      ...
      items.hammer ||
      items.firerod ||
      (items.byrna && (items.bottle > 0 || items.magic))
    );
  }
  function always() {
    return "available";
  ...
  function can_reach_outcast_glitched() {
    return (
      flags.glitches != "N" &&
      (items.boots || items.glove || items.flute) &&
      ((items.moonpearl && items.boots) || items.mirror)
    );
  }
  ...
  function canReachEDM() {
    ...
    return (
      (flags.glitches != "N" && items.boots) ||
      (((flags.glitches != "N" && items.mirror) || items.hookshot) &&
        canReachWDM()) ||
      (items.hammer && canReachToH())
    );
  }
  ...
  function canReachDDM() {
    // Dark Death Mountain
    return (
      (items.glove === 2 && canReachEDM()) ||
      (flags.glitches != "N" &&
        items.boots &&
        (items.moonpearl || items.hammer)) ||
      flags.glitches === "M" ||
      (canReachWDM() && flags.glitches != "N" && items.mirror)
    );
  }

  function canReachNWDW() {
    // North West Dark World
    return (
      (flags.glitches != "N" && canReachWDM() && items.mirror) ||
      (items.moonpearl &&
        ((canReachNEDW() &&
          items.hookshot &&
          (items.hammer || items.glove || items.flippers)) ||
  ...
  function canReachNEDW() {
    // North East Dark World
    return (
      (flags.glitches != "N" && items.moonpearl && items.boots) ||
      (flags.glitches != "N" &&
        items.mirror &&
        canReachWDM() &&
        (items.boots || items.moonpearl)) ||
      items.agahnim ||
      (items.moonpearl && items.hammer && items.glove) ||
      ((items.glove === 2 ||
        (flags.glitches != "N" && (canSpinSpeed() || items.mirror))) &&
        items.moonpearl &&
        (items.hammer || items.flippers || flags.glitches != "N"))
    ); // This last glitched logic stands for a Fake Flippers, in the code it also requires being able to take damage, sounds like Qirn Jump ?
  }
  ...
  function canReachSDW() {
    ...
    return (
      (items.moonpearl &&
        canReachNEDW() &&
        (items.hammer || (flags.glitches != "N" && canSpinSpeed()))) ||
      canReachNWDW()
    );
  }
  ...
  function canReachDP() {
    ...
    return (
      ...
      (flags.glitches != "N" && items.boots) ||
      flags.glitches === "M" ||
      (items.mirror && canReachMireArea())
    );
  }

  function canReachToH() {
    // Tower of Hera
    return (
      (flags.glitches != "N" && items.boots) ||
      flags.glitches === "M" ||
      ((items.mirror || (items.hookshot && items.hammer)) && canReachWDM())
    );
  }
  ...
  function canReachMireArea() {
    return (
      (items.glove === 2 &&
        (items.flute || (flags.glitches != "N" && items.boots))) ||
      (items.moonpearl && flags.glitches != "N" && items.boots && canReachSDW())
    );
  }
    ...
    if (flags.glitches === "O") {
      ...
      window.dungeons = [
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            return canReachNEDW() && items.moonpearl
              ? window.PoDBoss()
              : "unavailable";
          },
          can_get_chest: function () {
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            return canReachNWDW() && items.moonpearl
              ? window.SWBoss()
              : "unavailable";
          },
          can_get_chest: function () {
        ...
        },
        {
          ...
          is_beatable: function () {
            ...
            return canReachMireArea() && items.moonpearl
              ? window.MMBoss(medallion_check(0))
              : "unavailable";
          },
          can_get_chest: function () {
            if (!items.boots && !items.hookshot) return "unavailable";
            return canReachMireArea() && items.moonpearl
              ? window.MMChests(medallion_check(0))
              : "unavailable";
          },
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            return (items.mirror || (items.boots && items.moonpearl)) &&
              (items.boots ||
                items.somaria ||
                items.hookshot ||
                items.cape ||
              ...
              : medallionCheck(1) != "unavailable" &&
                  items.moonpearl &&
                  items.somaria &&
                  ((items.hammer && items.glove === 2 && canReachEDM()) ||
                    items.boots)
                ? window.TRFrontBoss(medallion_check(1))
                : "unavailable";
          },
          can_get_chest: function () {
            return (items.mirror || (items.boots && items.moonpearl)) &&
              ...
              : medallionCheck(1) != "unavailable" &&
                  ...
                  ((items.hammer && items.glove === 2 && canReachEDM()) ||
                    items.boots)
                ? window.TRFrontChests(medallion_check(1))
                : "unavailable";
          },
        },
        {
          ...
          can_get_chest: function () {
            return items.moonpearl &&
              ((crystalCheck() >= flags.opentowercount && canReachDDM()) ||
                (items.boots && canReachWDM()))
              ? window.GTChests()
              : "unavailable";
          },
        },
        {
          ...
          can_get_chest: function () {
            return window.doorCheck(
              11,
              false,
              false,
              flags.gametype != "S",
              ["glove", "killbomb", "bombdash"],
              "item",
            );
          },
        },
      ...
      window.agahnim = {
        ...
        is_available: function () {
          ...
          return (items.sword >= 2 ||
            (items.cape && items.sword) ||
            (flags.swordmode === "S" &&
              (items.hammer || (items.cape && items.net)))) &&
            (items.smallkeyhalf1 === 2 || flags.gametype == "R") &&
            agatowerweapon()
            ? items.lantern
              ? "available"
              : "darkavailable"
      ...
      window.chests = [
        ...
        },
        {
          ...
          is_available: function () {
            return canReachEDM()
              ? items.lantern || items.flute || items.boots
                ? "available"
                : "darkavailable"
              : "unavailable";
          },
        },
        {
          // [4]
          caption:
            "Mimic Cave ({mirror} outside of Turtle Rock)(Yellow = {medallion0} unkown OR possible w/out {firerod})",
          is_opened: false,
          is_available: function () {
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachMireArea() && (items.moonpearl || items.mirror)
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachSDW() && items.moonpearl
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            for (var k = 0; k < 10; k++) {
              if (prizes[k] === 1 && items["boss" + k]) return "available";
            }
            return "unavailable";
          },
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.moonpearl && canReachSDW()
              ? "available"
              : "unavailable";
          },
        },
        {
          // [27]
          caption:
            "Lazy Drunk Kid: Distract him with {bottle} because he can't lay off the sauce!",
          is_opened: false,
          is_available: function () {
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachNWDW() && items.moonpearl && items.glove === 2
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            return items.book &&
              ((items.mirror && canReachSDW()) || items.boots)
              ? items.sword >= 2 || (flags.swordmode === "S" && items.hammer)
                ? "available"
                : "information"
              : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return (items.mirror && canReachSDW()) || items.boots
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            return items.boots ||
              (items.mirror && canReachNWDW() && items.moonpearl)
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            return items.glove &&
              (items.boots || (canReachMireArea() && items.mirror))
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            return canReachNWDW()
              ? items.moonpearl && (items.boots || (items.glove && items.cape))
                ? "available"
                : "information"
              : "unavailable";
          },
        ...
        },
        {
          // [55]
          caption:
            "Escape Sewer Side Room (3) {bomb}/{boots}" +
            (flags.gametype === "S" ? "" : " (may need small key)"),
          is_opened: false,
          is_available: function () {
            if (flags.gametype === "S") return "available";
            if (flags.wildkeys || flags.gametype == "R") {
              if (items.glove) return "available";
              if (items.smallkeyhalf0 === 1 || flags.gametype == "R")
                return canDoTorchDarkRooms() ? "available" : "darkavailable";
              return "unavailable";
            }
          ...
          is_available: function () {
            return items.powder &&
              (items.hammer ||
                ...
                (items.mirror &&
                  items.moonpearl &&
                  ((items.glove === 2 && canReachNWDW()) ||
                    (canSpinSpeed() && canReachNEDW()))))
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: flags.gametype === "S",
          is_available: function () {
            return flags.gametype === "S" || canDoTorchDarkRooms()
              ? "available"
              : "darkavailable";
          },
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.flippers || items.boots || items.moonpearl
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            if (
              ...
              return "unavailable";
            return items.smallkeyhalf1 > 0 || flags.gametype === "R"
              ? items.lantern
                ? "available"
                : "darkavailable"
              : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachNWDW() && items.moonpearl && items.hammer
              ? "available"
              : "unavailable";
          },
        },
      ...
      window.chests = [
        ...
        },
        {
          // [55]
          caption:
            "Escape Sewer Side Room (3) {bomb}/{boots} (may need small key)",
          is_opened: false,
          is_available: always,
        },
        {
        ...
        },
        {
          // [61]
          caption:
            "Fat Fairy: Buy OJ bomb from Light Link's House after {crystal}5 {crystal}6 (2 items)",
          is_opened: false,
          is_available: always,
        },
        {
    ...
    //Is Inverted Mode
      ...
      window.dungeons = [
        {
          ...
          is_beatable: function () {
            ...
            var doorcheck = window.doorCheck(
              0,
              false,
              true,
              true,
        ...
        },
        {
          ...
          can_get_chest: function () {
            ...
            var doorcheck = window.doorCheck(
              ...
              false,
              false,
              ["boots", "glove", "firesource", "killbomb"],
              "item",
            );
            if (doorcheck) return doorcheck;
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            if (!items.moonpearl || !canReachLightWorldBunny())
              return "unavailable";
            var doorcheck = window.doorCheck(
              4,
              false,
              false,
              false,
              ["flippers", "mirror", "hookshot", "hammer", "bomb"],
              "boss",
            );
            if (doorcheck) return doorcheck;
        ...
        },
        {
          ...
          is_beatable: function () {
            var doorcheck = window.doorCheck(
              ...
              false,
              false,
              ["firerod", "swordorswordless", "mirrorskull", "bomb"],
              "boss",
            );
            if (doorcheck) return doorcheck;
        ...
        },
        {
          ...
          is_beatable: function () {
            ...
            if (flags.doorshuffle != "N") {
              ...
              if (doorcheck === "unavailable") return "unavailable";
              if (
                (medallionCheck(1) === "possible" ||
                  (!items.mirror && !items.bomb)) &&
                doorcheck === "available"
              )
                return "possible";
              if (
            ...
            if (
              ...
              if (!items.bigkey9 || medallionCheck(1) === "unavailable")
                return "unavailable";
          ...
          can_get_chest: function () {
            ...
            if (flags.doorshuffle != "N") {
              ...
              var doorcheck = window.doorCheck(
                ...
                true,
                false,
                ["somaria", "firerod", "laserbridge", "bombdash"],
                "item",
              );
              if (doorcheck === "unavailable") return "unavailable";
              if (
            ...
            if (
              ...
              if (medallionCheck(1) === "unavailable" || !items.somaria)
                return "unavailable";
        ...
        },
        {
          ...
          is_beatable: function () {
            ...
            if (flags.doorshuffle != "N") {
              ...
              if (doorcheck === "darkpossible") {
                ...
                if (doorcheck === "darkavailable") return "darkpossible";
                return doorcheck;
              }
              return window.doorCheck(
                10,
          ...
          can_get_chest: function () {
            ...
            if (crystalCheck() < 7 && crystalCheck() < flags.opentowercount)
              return "unavailable";
            if (flags.doorshuffle != "N") {
              var doorcheck =
                items.agahnim && items.mirror
      ...
      window.agahnim = {
        ...
        is_available: function () {
          ...
          if (flags.doorshuffle === "B") {
            ...
            return (items.sword ||
              (flags.swordmode === "S" &&
                (items.hammer || items.net)) /* && agatowerweapon()*/) &&
              (items.smallkeyhalf1 === 2 || flags.gametype === "R")
              ? items.lantern
                ? "available"
                : "darkavailable"
      ...
      window.chests = [
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.boots && items.glove === 2 && canReachLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachLightWorldBunny()
              ? items.moonpearl
                ? "available"
                : "unavailable"
              : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachLightWorld() && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return activeFlute() || (items.mirror && canReachLightWorldBunny())
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            return canReachLightWorldBunny()
              ? items.moonpearl && (items.bomb || items.boots)
                ? "available"
                : "unavailable"
              : "unavailable";
          },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.boots && canReachLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return (items.boots || items.hookshot) &&
              (items.glove ||
                (items.mirror &&
                  ((items.moonpearl && items.hookshot) || items.glove === 2)))
              ? items.lantern || activeFlute()
                ? "available"
                : "darkavailable"
              : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachLightWorldBunny() && items.bottle
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            return (items.mirror ||
              (items.glove === 2 && activeFlute()) ||
              (items.glove === 2 && (items.moonpearl || items.agahnim))) &&
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            if (canReachPyramid() && items.glove) return "available";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.glove || activeFlute()
              ? items.lantern
                ? "available"
                : "darkavailable"
              : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachLightWorld() && items.mushroom
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            return canReachLightWorldBunny()
              ? items.agahnim && items.boots && items.moonpearl
                ? "available"
                : "information"
              : "unavailable";
          },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachLightWorld() && items.glove
              ? "available"
              : "unavailable";
          },
        },
        {
          ...
          is_available: function () {
            return items.hammer &&
              (items.glove === 2 || (items.mirror && canReachLightWorldBunny()))
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return canReachLightWorldBunny() && (items.bomb || items.boots)
              ? items.moonpearl
                ? "available"
                : "possible"
              : "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (doorcheck)
              return doorcheck === "available" && !items.moonpearl
                ? "possible"
                : doorcheck;
            return "available";
          },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            if (canReachPyramid()) return "available";
            return "unavailable";
          },
        },
        {
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.shovel && canReachLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.powder && items.hammer && canReachLightWorld()
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (doorcheck) return items.moonpearl ? doorcheck : "unavailable";
            return canReachLightWorldBunny() && items.moonpearl
              ? canDoTorchDarkRooms()
                ? "available"
                : "darkavailable"
              : "unavailable";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (flags.gametype === "R") {
              ...
              return (activeFlute() || items.glove) &&
                (items.smallkeyhalf1 > 0 || flags.gametype == "R")
                ? items.lantern
                  ? "available"
                  : "darkavailable"
                : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            if (items.hammer || items.flippers) return "available";
            return items.mirror && canReachLightWorldBunny()
              ? items.moonpearl
                ? "available"
                : "possible"
              : "unavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.flippers && (canReachLightWorld() || items.glove === 2)
              ? "available"
              : "unavailable";
          },
        },
      ...
      window.dungeons = [
        ...
        },
        {
          ...
          can_get_chest: function () {
            ...
            var doorcheck = window.doorCheck(
              ...
              false,
              false,
              ["boots", "glove", "firesource", "killbomb", "mirrordesert"],
              "item",
            );
            if (doorcheck) return doorcheck;
            return window.DPChests();
        ...
        },
        {
          ...
          is_beaten: false,
          is_beatable: function () {
            if (!can_reach_outcast() || !canReachDarkWorld())
              return "unavailable";
            var doorcheck = window.doorCheck(
              5,
              false,
        ...
        },
        {
          ...
          can_get_chest: function () {
            ...
            var doorcheck = window.doorCheck(
              ...
              true,
              false,
              ["somaria", "firerod", "laserbridge", "bomb"],
              "item",
            );
            if (doorcheck) {
              if (doorcheck === "unavailable") return "unavailable";
      ...
      window.chests = [
        {
          ...
          is_available: function () {
            ...
            if ((can_reach_outcast() && items.mirror) || items.glove === 2)
              return "available";
            return "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            var state = medallionCheck(1);
            if (state)
              return state === "possible" && !items.flute && !items.lantern
                ? "darkpossible"
                : state;
            ...
            if (flags.wildkeys) {
              return items.smallkey9 <= 1 && flags.gametype != "R"
                ? "unavailable"
                : items.lantern || items.flute
                  ? "available"
                  : "darkavailable";
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return can_reach_outcast() && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return items.moonpearl && items.flute && items.glove === 2
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return can_reach_outcast() && items.mirror && items.bomb
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (items.flute && items.glove === 2 && items.mirror)
              return "available";
            if (!items.book) return "information";
            if (flags.doorshuffle != "N") return "possible";
        ...
        },
        {
          ...
          is_available: function () {
            ...
            if (doorcheck) return doorcheck;
            return items.bomb || melee_bow() || items.firerod || cane()
              ? "available"
              : "partialavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            ...
            return (items.hammer && (items.agahnim || items.glove)) ||
              (items.agahnim && items.mirror && can_reach_outcast())
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_opened: false,
          is_available: function () {
            return can_reach_outcast() && items.hammer
              ? "available"
              : "unavailable";
          },
        },
        ...
        },
        {
          ...
          is_available: function () {
            return items.moonpearl &&
              ((items.agahnim &&
                (items.flippers || items.hammer || items.glove)) ||
                (items.hammer && items.glove) ||
                (items.glove === 2 && items.flippers))
              ? "available"
              : "unavailable";
